...
class SpectrometerView {
    ...
    public method setResult { mtrName phi timestamp rList aList tList {t0 0}}
...
body SpectrometerView::updateDarkAndReferenceLog { } {
    ...
    set fmtW "%#$wWidth.1f"
    set fmtR "%$refWidth.0f"
    set fmtD "%$drkWidth.0f"
...
body SpectrometerView::setResult { motorName p title rList aList tList {t0 0}} {
    set m_motorName $motorName
    set m_position $p

    set motorDisplayName [getMotorDisplayName $m_motorName]

    if {$m_motorName != "time" && !$itk_option(-hideSaveAndMoveButton)} {
...
body MicroSpectScanResult::loadFile { path_ {fullLoad 0}} {
    ...
    ########################33
    ### TODO:
    ### you may add motor check for mode here
    #####################################
