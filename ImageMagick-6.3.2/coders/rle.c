  ...
  do
  {
    ...
    */
    ...
    if ((number_planes == 0) || (number_planes == 2) || (bits_per_pixel != 8) ||
        (image->columns == 0))
      ThrowReaderException(CorruptImageError,"UnsupportedRLEImageFile");
    if (flags & 0x02)
      {
        /*
    ...
    if (number_colormaps != 0)
      {
        ...
        */
        colormap=(unsigned char *)
          AcquireMagickMemory(number_colormaps*map_length);
    ...
    if ((flags & 0x08) != 0)
      {
        ...
        */
        ...
        if (length != 0)
          {
            comment=(char *) AcquireMagickMemory(length);
    ...
    */
    ...
    rle_pixels=(unsigned char *)
      AcquireMagickMemory(image->columns*image->rows*number_planes);
