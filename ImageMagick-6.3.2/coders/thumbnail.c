...
%
*/
ModuleExport void RegisterTHUMBNAILImage(void)
{
  MagickInfo
    *entry;

  entry=SetMagickInfo("THUMBNAIL");
  entry->encoder=(EncoderHandler *) WriteTHUMBNAILImage;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  WriteTHUMBNAILImage() writes an image of clip bytes to a file.  It
  ...
  Image *image)
{
  ...
  thumbnail_image=BlobToImage(image_info,GetStringInfoDatum(profile)+offset+i-2,length,
    &image->exception);
  if (thumbnail_image == (Image *) NULL)
    return(MagickFalse);
  (void) SetImageType(thumbnail_image,TrueColorType);
