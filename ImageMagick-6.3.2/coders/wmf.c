...
static void ipa_device_close(wmfAPI * API)
{
  ...
  ddata->draw_wand=DestroyDrawingWand(ddata->draw_wand);
}
...
static void util_set_pen(wmfAPI * API, wmfDC * dc)
{
  ...
  DrawSetStrokeWidth(WmfDrawingWand, MagickMax(0, pen_width));
...
static wmfFontMap WMFFontMap[] = {
  { "Courier",            "Courier",     "Courier-Oblique",   "Courier-Bold", "Courier-BoldOblique"   },   { "Helvetica",          "Helvetica",   "Helvetica-Oblique", "Helvetica-Bold", "Helvetica-BoldOblique" },   { "Modern",             "Courier",     "Courier-Oblique",   "Courier-Bold", "Courier-BoldOblique"   },   { "Monotype Corsiva",   "Courier",     "Courier-Oblique",   "Courier-Bold", "Courier-BoldOblique"   },
...
static void lite_font_map( wmfAPI* API, wmfFont* font)
{
  ...
  magick_font->ps_name=(char *) RelinquishMagickMemory(magick_font->ps_name);
