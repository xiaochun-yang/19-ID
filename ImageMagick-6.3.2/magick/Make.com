...
$ call Make import.c
$ call Make mogrify.c
$ copy animate.c w_animate.c
$ call make w_animate.c
$ copy compare.c w_compare.c
$ call make w_compare.c
$ copy composite.c w_composite.c
$ call make w_composite.c
$ copy display.c w_display.c
$ call make w_display.c
$ copy identify.c w_identify.c
$ call make w_identify.c
$ copy montage.c w_montage.c
$ call make w_montage.c
$ set default [-.magick]
$ deass magick
$ deass wand
$library/create libMagick.olb -
  animate, annotate, blob, cache, cache-view, client, coder, -
  color, colorspace, compare, composite, compress, configure, -
  constitute, decorate, delegate, deprecate, display, draw, -
  effect, enhance, exception, fx, gem, geometry, hashmap, identify, image, -
  layer, list, locale, log, magic, magick, memory, mime, module, -
  monitor, montage, option, paint, pixel, PreRvIcccm, profile, quantize, -
  quantum,random, registry, resize, resource, segment, semaphore, shear, -
  signature, splay-tree, static, stream, string, timer, token, transform, -
  threshold, type, utility, version, vms, widget, xwindow, statistic, -
	prepress, property, xml-tree, -
	[-.filters]analyze,[-.wand]drawing-wand,pixel-wand,conjure,convert,-
   import,mogrify,w_animate,w_compare,w_composite,w_display,w_identify,-
   w_montage
$exit
$
$Make: subroutine
