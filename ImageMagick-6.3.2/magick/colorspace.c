    ...
    case CMYKColorspace:
    {
      ...
      */
      ...
      for (y=0; y < (long) image->rows; y++)
      {
        ...
        {
          black=(MagickRealType) QuantumRange-q->red;
          if ((QuantumRange-q->green) < black)
            black=(MagickRealType) QuantumRange-q->green;
          if ((QuantumRange-q->blue) < black)
            black=(MagickRealType) QuantumRange-q->blue;
          cyan=(MagickRealType) QuantumRange*(QuantumRange-q->red-black)/
            (QuantumRange-black);
          magenta=(MagickRealType) QuantumRange*(QuantumRange-q->green-black)/
            (QuantumRange-black);
          yellow=(MagickRealType) QuantumRange*(QuantumRange-q->blue-black)/
            (QuantumRange-black);
          q->red=RoundToQuantum(cyan);
          q->green=RoundToQuantum(magenta);
          q->blue=RoundToQuantum(yellow);
          indexes[x]=(IndexPacket) RoundToQuantum(black);
          q++;
        }
    ...
    case GRAYColorspace:
    {
      ...
      */
      ...
      if (image->storage_class == PseudoClass)
        ...
        {
          image->colormap[i].red=PixelIntensityToQuantum(image->colormap+i);
...
#define DisplayGamma  (1.0/1.7)
      ...
      */
      ...
      logmap=(Quantum *) AcquireMagickMemory((size_t) (MaxMap+1)*
        sizeof(*logmap));
      ...
      for (i=0; i <= (long) MaxMap; i++)
        logmap[i]=ScaleMapToQuantum((unsigned long) (MaxMap*(reference_white+
...
#define D50Y  (1.0)
#define D50Z  (0.8249)
#define MaxYCC  ((MagickRealType) (1.3584*MaxMap+0.5))
#define TransformRGBImageTag  "Transform/Image"
  ...
  switch (colorspace)
  {
      ...
      for (y=0; y < (long) image->rows; y++)
      {
        ...
        for (x=0; x < (long) image->columns; x++)
        {
          q->red=RoundToQuantum((MagickRealType) (QuantumRange-
            QuantumScale*q->red*(QuantumRange-indexes[x])+indexes[x]));
          q->green=RoundToQuantum((MagickRealType) (QuantumRange-
            QuantumScale*q->green*(QuantumRange-indexes[x])+indexes[x]));
          q->blue=RoundToQuantum((MagickRealType) (QuantumRange-
            QuantumScale*q->blue*(QuantumRange-indexes[x])+indexes[x]));
          q++;
        }
        if (SyncImagePixels(image) == MagickFalse)
          break;
      ...
      */
      ...
      for (y=0; y < (long) image->rows; y++)
      {
        ...
        for (x=0; x < (long) image->columns; x++)
        {
          ...
          HSBTransform(hue,saturation,brightness,&q->red,&q->green,&q->blue);
          q++;
        }
        if (SyncImagePixels(image) == MagickFalse)
          break;
    ...
    {
      /*
        Transform image from LAB to XYZ.
          * * * not implemented * * *
      */
      if (image->storage_class == PseudoClass)
        {
    ...
    case Rec709YCbCrColorspace:
    {
      ...
      */
      for (i=0; i <= (long) MaxMap; i++)
      {
        ...
        x_map[i].z=(double) i;
        y_map[i].x=0.0;
        y_map[i].y=(-0.187324*0.5)*(2.0*i-MaxMap);
        y_map[i].z=(1.855600*0.5)*(2.0*i-MaxMap);
        z_map[i].x=(1.574800*0.5)*(2.0*i-MaxMap);
        z_map[i].y=(-0.468124*0.5)*(2.0*i-MaxMap);
        z_map[i].z=0.0;
      }
      break;
    }
          ...
          switch (colorspace)
          {
            ...
            case YCCColorspace:
            {
              ...
              if (colorspace == sRGBColorspace)
                {
                  q->red=(Quantum) ScaleToQuantum(sRGBMap[
                    ScaleQuantumToChar((Quantum) quantum.red)]);
                  q->green=(Quantum) ScaleToQuantum(sRGBMap[
                    ScaleQuantumToChar((Quantum) quantum.green)]);
                  q->blue=(Quantum) ScaleToQuantum(sRGBMap[
                    ScaleQuantumToChar((Quantum) quantum.blue)]);
                  break;
                }
              q->red=(Quantum) ScaleToQuantum(YCCMap[
                ScaleQuantumToChar((Quantum) quantum.red)]);
              q->green=(Quantum) ScaleToQuantum(YCCMap[
                ScaleQuantumToChar((Quantum) quantum.green)]);
              q->blue=(Quantum) ScaleToQuantum(YCCMap[
                ScaleQuantumToChar((Quantum) quantum.blue)]);
              break;
            }
            default:
      ...
      for (i=0; i < (long) image->colors; i++)
      {
        ...
        switch (colorspace)
        {
          ...
          case YCCColorspace:
          {
            ...
            if (colorspace == sRGBColorspace)
              {
                image->colormap[i].red=(Quantum) ScaleToQuantum(sRGBMap[
                  ScaleQuantumToChar((Quantum) quantum.red)]);
                image->colormap[i].green=(Quantum) ScaleToQuantum(sRGBMap[
                  ScaleQuantumToChar((Quantum) quantum.green)]);
                image->colormap[i].blue=(Quantum) ScaleToQuantum(sRGBMap[
                  ScaleQuantumToChar((Quantum) quantum.blue)]);
                break;
              }
            image->colormap[i].red=(Quantum) ScaleToQuantum(YCCMap[
              ScaleQuantumToChar((Quantum) quantum.red)]);
            image->colormap[i].green=(Quantum) ScaleToQuantum(YCCMap[
              ScaleQuantumToChar((Quantum) quantum.green)]);
            image->colormap[i].blue=(Quantum) ScaleToQuantum(YCCMap[
              ScaleQuantumToChar((Quantum) quantum.blue)]);
            break;
          }
          default:
