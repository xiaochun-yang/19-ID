  ...
  Image *images)
{
  ...
  argv[0]=(char *) RelinquishMagickMemory(argv[0]);
  ...
  XResourceInfo *resource_info,XWindows *windows,Image *image)
{
  ...
  */
  ...
  annotate_info->text=(char *) AcquireMagickMemory((size_t)
    windows->image.width/MagickMax(font_info->min_bounds.width,1)+2);
          ...
          case XK_KP_Enter:
          {
            ...
            *p='\0';
            ...
            annotate_info->next=(XAnnotateInfo *)
              AcquireMagickMemory(sizeof(*annotate_info->next));
            if (annotate_info->next == (XAnnotateInfo *) NULL)
              return(MagickFalse);
        ...
        switch (ColorEditCommands[id])
        {
          ...
          case ColorEditFuzzCommand:
          {
            ...
            */
            ...
            if (entry != 5)
              {
                (*image)->fuzz=StringToDouble(FuzzMenu[entry],QuantumRange+1.0);
                break;
              }
            ...
            (*image)->fuzz=StringToDouble(fuzz,QuantumRange+1.0);
            break;
          }
        ...
        switch (CompositeCommands[id])
        {
          case CompositeOperatorsCommand:
          {
            ...
            /*
              Select a command from the pop-up menu.
            */
            operators=GetMagickOptions(MagickCompositeOptions);
            ...
            if (entry >= 0)
              compose=(CompositeOperator) ParseMagickOption(
                MagickCompositeOptions,MagickFalse,operators[entry]);
  ...
  if (blend != 0.0)
    {
      ...
      */
      ...
      opacity=(Quantum) (ScaleQuantumToChar(QuantumRange)-
        ((long) ScaleQuantumToChar(QuantumRange)*blend)/100);
      if (SetImageStorageClass(image,DirectClass) == MagickFalse)
        return(MagickFalse);
  ...
  XResourceInfo *resource_info,XWindows *windows,Image *image)
{
  ...
  */
  if ((window_changes.width < windows->image.ximage->width) ||
      (window_changes.height < windows->image.ximage->height))
    {
  ...
  XResourceInfo *resource_info,XWindows *windows,Image **image)
{
  ...
  */
  ...
  coordinate_info=(XPoint *)
    AcquireMagickMemory((size_t) max_coordinates*sizeof(*coordinate_info));
      ...
      switch (event.type)
      {
        ...
        case ButtonRelease:
        {
          ...
          */
          ...
          max_coordinates<<=1;
          coordinate_info=(XPoint *) ResizeMagickMemory(coordinate_info,
      ...
      if (mozilla_window != (Window) NULL)
        {
          ...
          */
          ...
          url=(char *) RelinquishMagickMemory(url);
  ...
  if (status == MagickFalse)
    {
      ...
      ThrowXWindowException(XServerError,image->exception.reason,message);
          ...
          case MatteEditValueCommand:
          {
            ...
            */
            ...
            (void) FormatMagickString(message,MaxTextExtent,
              "Enter matte value (0 - " QuantumFormat "):",QuantumRange);
        ...
        switch (method)
        {
          ...
          case FillToBorderMethod:
          {
            ...
            */
            ...
            (void) MatteFloodfillImage(*image,target,(Quantum) atoi(matte),
      ...
      if (status == 0)
        {
          ...
          message=GetExceptionMessage(errno);
          ThrowXWindowException(XServerError,"UnableToGetProperty",message);
          message=(char *) RelinquishMagickMemory(message);
          return((Image *) NULL);
        }
      filelist=(char **) AcquireMagickMemory((size_t) count*sizeof(*filelist));
  ...
  XResourceInfo *resource_info,Image *image)
{
  ...
  if (visual_info == (XVisualInfo *) NULL)
    {
      ...
      */
      ...
      if (map_info == (XStandardColormap *) NULL)
        ThrowMagickFatalException(XServerFatalError,"MemoryAllocationFailed",
          image->filename);
  ...
  */
  ...
  if (pixel.annotate_context == (GC) NULL)
    ThrowMagickFatalException(XServerFatalError,"UnableToCreateGraphicContext",
      image->filename);
  /*
  ...
  */
  ...
  status=XMakeImage(display,&resources,&window_info,image,window_info.width,
    window_info.height);
  if (status == MagickFalse)
    ThrowMagickFatalException(XServerFatalError,"UnableToCreateXImage",
      image->filename);
  window_info.x=0;
  window_info.y=0;
  if (image->debug != MagickFalse)
  ...
  */
  ...
  if (window_info.pixmap == (Pixmap) NULL)
    ThrowMagickFatalException(XServerFatalError,"UnableToCreateXPixmap",
      image->filename);
  /*
...
#define MagickTitle  "Commands"
  ...
  if ((*image)->debug != MagickFalse)
    (void) LogMagickEvent(TraceEvent,GetMagickModule(),"%s",(*image)->filename);
  display_image=(*image);
  (void) SetImageColorspace(display_image,RGBColorspace);
  ...
  */
  ...
  if (windows->font_info == (XFontStruct *) NULL)
    ThrowMagickFatalException(XServerFatalError,"UnableToLoadFont",
      resource_info->font);
  /*
    Initialize Standard Colormap.
  */
  ...
  if ((resource_info->title != (char *) NULL) && !(*state & MontageImageState))
    {
      ...
      title=(char *) RelinquishMagickMemory(title);
    }
  else
    {
      char
  ...
  */
  ...
  if (windows->magnify.cursor == (Cursor) NULL)
    ThrowMagickFatalException(XServerFatalError,"UnableToCreateCursor",
      display_image->filename);
