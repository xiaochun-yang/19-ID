...
%                                                                             %
%                                                                             %
%            ImageMagick Self-adjusting Binary Search Tree Methods            %
%                                                                             %
%                              Software Design                                %
%                                John Cristy                                  %
%                               December 2002                                 %
...
static void BalanceSplayTree(SplayTreeInfo *splay_info)
{
  ...
  nodes=(NodeInfo **) AcquireMagickMemory((size_t) splay_info->nodes*
    sizeof(*nodes));
  ...
  int (*method)(NodeInfo *,const void *),const void *value)
{
  ...
  nodes=(NodeInfo **) AcquireMagickMemory((size_t) splay_info->nodes*
    sizeof(*nodes));
  transitions=(unsigned char *) AcquireMagickMemory((size_t) splay_info->nodes*
    sizeof(*transitions));
