        ...
        if (LocaleCompare("profile",option+1) == 0)
          {
            ...
            */
            ...
            while (name != (const char *) NULL)
            {
              ...
              if (profile != (StringInfo *) NULL)
                (void) ProfileImage(*image,name,GetStringInfoDatum(profile),(unsigned long)
        ...
        if (LocaleCompare("set",option+1) == 0)
          {
            ...
            */
            ...
            if (*option == '-')
              (void) SetImageProperty(*image,argv[i+1],argv[i+2]);
            break;
          }
        ...
        if (LocaleCompare("stroke",option+1) == 0)
          {
            ...
            sans=DestroyExceptionInfo(sans);
            if (status == MagickFalse)
              draw_info->stroke_pattern=ReadImage(image_info,exception);
            break;
          }
        ...
        if (LocaleCompare("tile",option+1) == 0)
          {
            ...
            if (fill_pattern == (Image *) NULL)
              break;
            draw_info->fill_pattern=CloneImage(fill_pattern,0,0,MagickTrue,
              exception);
        ...
        if (LocaleCompare("fuzz",option+1) == 0)
          {
            ...
            image_info->fuzz=StringToDouble(argv[i+1],QuantumRange+1.0);
            break;
          }
        break;
      }
        ...
        if (LocaleCompare("list",option+1) == 0)
          {
            ...
            */
            ...
            switch (list)
            {
              ...
              default:
              {
                (void) ListMagickOptionInfo((FILE *) NULL,(MagickOption) list, 
                  exception);
                break;
              }
            }
        ...
        if (LocaleCompare("page",option+1) == 0)
          {
            ...
            canonical_page=(char *) RelinquishMagickMemory(canonical_page);
        ...
        if (LocaleCompare("mask",option+1) == 0)
          {
            ...
            image=RemoveFirstImageFromList(images);
            mask=RemoveFirstImageFromList(images);
            if (mask == (Image *) NULL)
              break;
            image->mask=mask;
            (void) NegateImage(image->mask,MagickFalse);
        ...
        if (LocaleCompare("process",option+1) == 0)
          {
            ...
            for (j=1; j < number_arguments; j++)
              arguments[j]=(char *) RelinquishMagickMemory(arguments[j]);
