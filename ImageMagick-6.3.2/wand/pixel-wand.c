...
WandExport Quantum PixelGetAlphaQuantum(const PixelWand *wand)
{
  ...
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,GetMagickModule(),"%s",wand->name);
  return(QuantumRange-RoundToQuantum(wand->pixel.opacity));
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  double *saturation,double *luminosity)
{
  ...
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,GetMagickModule(),"%s",wand->name);
  TransformHSL(RoundToQuantum(wand->pixel.red),RoundToQuantum(
...
WandExport void PixelGetQuantumColor(const PixelWand *wand,PixelPacket *color)
{
  ...
  if (wand->pixel.colorspace == CMYKColorspace)
    {
      color->red=RoundToQuantum(QuantumRange-(wand->pixel.red*(QuantumRange-
        wand->pixel.index)+wand->pixel.index));
      color->green=RoundToQuantum(QuantumRange-(wand->pixel.green*(QuantumRange-
        wand->pixel.index)+wand->pixel.index));
      color->blue=RoundToQuantum(QuantumRange-(wand->pixel.blue*(QuantumRange-
        wand->pixel.index)+wand->pixel.index));
      return;
    }
...
WandExport void PixelSetAlpha(PixelWand *wand,const double alpha)
{
  ...
  wand->pixel.opacity=(MagickRealType) (QuantumRange-
    RoundToQuantum(QuantumRange*alpha));
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
WandExport void PixelSetBlack(PixelWand *wand,const double black)
{
  ...
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,GetMagickModule(),"%s",wand->name);
  wand->pixel.index=(MagickRealType) RoundToQuantum(QuantumRange*black);
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
WandExport void PixelSetBlue(PixelWand *wand,const double blue)
{
  ...
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,GetMagickModule(),"%s",wand->name);
  wand->pixel.blue=(MagickRealType) RoundToQuantum(QuantumRange*blue);
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
WandExport void PixelSetCyan(PixelWand *wand,const double cyan)
{
  ...
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,GetMagickModule(),"%s",wand->name);
  wand->pixel.red=(MagickRealType) RoundToQuantum(QuantumRange*cyan);
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
WandExport void PixelSetGreen(PixelWand *wand,const double green)
{
  ...
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,GetMagickModule(),"%s",wand->name);
  wand->pixel.green=(MagickRealType) RoundToQuantum(QuantumRange*green);
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
WandExport void PixelSetMagenta(PixelWand *wand,const double magenta)
{
  ...
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,GetMagickModule(),"%s",wand->name);
  wand->pixel.green=(MagickRealType) RoundToQuantum(QuantumRange*magenta);
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
WandExport void PixelSetOpacity(PixelWand *wand,const double opacity)
{
  ...
  wand->pixel.opacity=(MagickRealType) RoundToQuantum(QuantumRange*opacity);
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
WandExport void PixelSetRed(PixelWand *wand,const double red)
{
  ...
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,GetMagickModule(),"%s",wand->name);
  wand->pixel.red=(MagickRealType) RoundToQuantum(QuantumRange*red);
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
WandExport void PixelSetYellow(PixelWand *wand,const double yellow)
{
  ...
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,GetMagickModule(),"%s",wand->name);
  wand->pixel.blue=(MagickRealType) RoundToQuantum(QuantumRange*yellow);
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
