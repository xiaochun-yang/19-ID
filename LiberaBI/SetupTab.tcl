...
body SetupTab::addTools {} {
	...
	#puts "test test test in SetupTab::addTools"
	#puts $this
	#puts $beamline
...
body SetupTab::launchWidget { name  } {
	#puts "test test test in launchWidget with arg $name"
	...
	switch $name {
       ...
       libera_control {  
			if [checkAndActivateExistingDocument $name] return
			set path [$itk_component(Mdi) addDocument $name \
		            -title "Libera Control"  -resizable 1  -width 900 -height 220]
