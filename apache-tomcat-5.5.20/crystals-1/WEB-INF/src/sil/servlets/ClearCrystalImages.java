...
/**
 */
public class ClearCrystalImages extends SilServlet
{
	/**
	 */
        ...
        throws ServletException, IOException
    {
		...
		if (groupStr != null) {
			try {
				...
				eventId = silServer.clearCrystalImages(silId, row, group, key, crystalId);
			} catch (NumberFormatException e) {
				throw new InvalidQueryException(ServletUtil.RC_439, key);
			}
			...
			// Submit change to the event queue for this silid
			eventId = silServer.clearCrystalImages(silId, row, key, crystalId);
		}
