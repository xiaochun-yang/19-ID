...
if ($#argv != 1) then
	echo `date +"%T"` " Wrong number of commandline arguments for con_recaluclate_phi.csh" >>& autoindex.out
	echo `date +"%T"` " Usage: con_recaluclate_phi.csh <input file>" >>& autoindex.out
	exit 1
endif
