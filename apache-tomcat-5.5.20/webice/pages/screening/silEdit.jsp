...
<p class="warning">Please select a cassette.</p>
<form action="loadSilList.do">
<input class="actionbutton1" type="submit" value="Cassette List"/>
</form>
<%
		} else { %>


<p>Enter comments next to the appropriate field (note that some
fields are protected). When you have finished click on the <b>Set
Crystal</b> button.</p>
<%
...
//	} catch (Exception e) {
//		WebiceLogger.error("ERROR in silOverview.jsp: " + e.getMessage(), e);
//		throw e;
//	}
