...
class RasterMatrixView {
    ...
    protected method handleNewOutput { } {
        if {$_gateOutput == 0} {
            $itk_component(s_canvas) config -cursor watch
        } else {
            $itk_component(s_canvas) config -cursor [. cget -cursor]
        }
        updateBubble
    }
    ...
    constructor { args } {
        ...
        registerComponent $itk_component(s_canvas)
    ...
    constructor { args } {
        ...
        if {$gInlineCameraExists} {
            itk_component add sample_video {
                ...
                keep -videoEnabled
                rename -beamWidthWidget beamWidthDevice beamWidthDevice BeamWidthDevice
                rename -beamHeightWidget beamHeightDevice beamHeightDevice BeamHeightDevice
            }
        ...
        itk_component add diff_viewer {
            ...
            keep -imageServerHost
            keep -imageServerHttpPort
        }
