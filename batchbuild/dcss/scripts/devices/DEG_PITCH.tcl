...
proc PREFIX_pitch_move { new_PREFIX_pitch } {
	...
	set new_PREFIX_vert_1 [calculate_PREFIX_vert_1 $gDevice(PREFIX_vert,target) $new_PREFIX_pitch]
	set new_PREFIX_vert_2 [calculate_PREFIX_vert_2 $gDevice(PREFIX_vert,target) $new_PREFIX_pitch]
