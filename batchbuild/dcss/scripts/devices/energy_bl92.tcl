...
proc energy_motorlist {} {
        ...
        # specify motors which move during e-tracking for BL9-2, omitting mono_angle/mono_theta/mono_theta_corr
...
proc energy_move { new_energy } {
    ...
    [energy_calculate_table_vert_1 $new_mono_theta_corr] + \
    $table_vert_1_offset \
    ]

	set new_table_vert_2 [expr \
    [energy_calculate_table_vert_2 $new_mono_theta_corr] + \
    $table_vert_2_offset  \
    ]
...
#comment next lines for standard energy reset for 9-2; Uncomment to roll back 
...
#to roll back replace next lines with  set table_vert_offset [expr $table_vert - [energy_calculate_table_vert $new_mono_theta_corr]]


    set table_vert_1_offset [expr $table_vert_1 - [energy_calculate_table_vert_1 $new_mono_theta_corr]]
    set table_vert_2_offset [expr $table_vert_2 - [energy_calculate_table_vert_2 $new_mono_theta_corr]]
