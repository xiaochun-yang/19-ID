...
proc mirror_slit_horiz_gap_move { new_mirror_slit_horiz_gap } {
	...
	set new_mirror_slit_ssrl [mirror_slit_ssrl_calculate $gDevice(mirror_slit_horiz,target) $new_mirror_slit_horiz_gap]
	set new_mirror_slit_spear [mirror_slit_spear_calculate $gDevice(mirror_slit_horiz,target) $new_mirror_slit_horiz_gap]
