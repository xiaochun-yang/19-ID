...
proc mirror_vert_chin_move { new_mirror_vert_chin } {
	...
	if { $new_mirror_vert < $mirror_vert } {
        assertMotorLimit mirror_chin_gap [mirror_chin_gap_calculate $new_mirror_vert $mirror_slit_lower]	
        ...
        assertMotorLimit mirror_chin_gap [mirror_chin_gap_calculate $mirror_vert $new_mirror_slit_lower]	
