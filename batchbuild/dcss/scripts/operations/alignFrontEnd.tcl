...
proc alignFrontEnd_vert {ic step points time minscany maxscanx flux wmin wmax glc grc} {
	...
	if { [catch {
	    ...
	    set new_slit_1_vert [expr - $phi_offset + $slit_1_vert]
	    ...
	    wait_for_devices table_vert slit_1_vert slit_2_vert sample_x
...
proc alignFrontEnd_horz {ic step points time minscanx maxscany minscany maxscanx flux wmin wmax glc grc method} {
	...
	if { [catch {
	    ...
	    set new_slit_1_horiz [expr - $kappa_offset + $slit_1_horiz]
	    ...
	    wait_for_devices $horiz_motor slit_1_horiz slit_2_horiz sample_z sample_x
	...
	if { [catch {
		...
		set new_slit_1_horiz [expr - $z_offset + $slit_1_horiz]
		...
		move slit_1_horiz to $new_slit_1_horiz
		move slit_2_horiz to $new_slit_2_horiz
		wait_for_devices $horiz_motor slit_1_horiz slit_2_horiz sample_z
