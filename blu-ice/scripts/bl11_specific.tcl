...
wm title . "BLU-ICE    Beamline 11-1"
...
proc initialize_components {} {
	...
	create_real_motor		mono_filter			mf	   default	" mm $gFont(micron) "
	...
	# define extra motors
	create_real_motor		camera_pan		cp		default		" mm $gFont(micron) "
	create_real_motor		camera_tilt		ct		default		" mm $gFont(micron) "
	...
	create_pseudo_motor	doseIntegrationPeriod dip	default 	" mm $gFont(micron) "
