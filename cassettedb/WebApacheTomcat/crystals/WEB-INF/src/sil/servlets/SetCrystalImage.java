...
/**
 */
public class SetCrystalImage extends SilServlet
{
	/**
	 */
        ...
        throws ServletException, IOException
    {
		...
		int eventId = silServer.setCrystalImage(silId, row, fields, key);
		...
		out.close();
			...
			response.sendError(500, "Failed to set crystal image. Root cause " + e.getMessage());
		}
