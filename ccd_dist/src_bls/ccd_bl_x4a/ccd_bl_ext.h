...
extern int		command_in_progress;
extern int		abort_asserted;
...
extern	float	near_limit_value;
extern	float	far_limit_value;
extern	float	far_home_value;
extern	float	near_2theta_limit_value;
extern	float	far_2theta_limit_value;
extern	char	returned_to_user[256];
extern	double	stat_slits[4];
...
extern	float   stat_xl_guard_hslit;
extern	float   stat_xl_guard_vslit;
extern	float   stat_xl_up_hhs;
extern	float   stat_xl_up_vhs;
extern	float   stat_xl_dn_hhs;
extern	float   stat_xl_dn_vhs;
extern	int 	input_socket_time_grain;
extern	int 	ion_check_interval;
extern	int 	ion_check_accumulator;
extern	int 	local_control_port;
extern	char 	local_control_host[256];
