...
extern	char	bl_returned_string[1024];
...
extern	int	stat_adc;
extern	int	stat_bin;
extern	float	stat_slits[2];
extern	float	stat_ion[3];
extern	float	stat_xl_ion_up;
extern	float	stat_xl_ion_dn;
extern	float	stat_xl_ion_beam;
extern	float	stat_xl_hslit;
extern	float	stat_xl_vslit;
extern	float	stat_xl_up_hhs;
extern	float	stat_xl_up_vhs;
extern	float	stat_xl_dn_hhs;
extern	float	stat_xl_dn_vhs;
extern	int	stat_onetime[100];
