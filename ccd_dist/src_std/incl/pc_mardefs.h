...
struct spiral_header {
        long	sp_total_pixels_x;
	long	sp_total_pixels_y;
        long	sp_lrecl;
	long	sp_max_rec;
        long	sp_overflow_pixels;
	long	sp_overflow_records;
        long	sp_counts_per_sec_start;
	long	sp_counts_per_sec_end;
        long	sp_exposure_time_sec;
        long	sp_programmed_exp_time_units;
	...
	long	sp_nc_rec;
	long	sp_nc_poff;
	long	sp_rest_of_header[219 + 256];
	};
