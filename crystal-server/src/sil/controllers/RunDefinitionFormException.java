...
public class RunDefinitionFormException extends ModelAndViewDefiningException {
	
	private static final long serialVersionUID = 1L;

	public RunDefinitionFormException(String view, String message)
	{
		this(view, "exception", message);
	}

	public RunDefinitionFormException(String view, String name, String message)
	{
		super(new ModelAndView(view, createHashMap(new Object[]{name, message})));
	}
	
	public RunDefinitionFormException(ModelAndView viewAndModel)
	{
		super(viewAndModel);
	}
