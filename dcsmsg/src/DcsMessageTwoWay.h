...
//this is for the convenient of sending out message by components
//inside of the two way class that is the tcp/ip side
class DcsMessageSender
{
public:
    DcsMessageSender( ) { }
    virtual ~DcsMessageSender( ) { }
    virtual void sendoutDcsMessage( DcsMessage* pMsg ) = 0;
};
