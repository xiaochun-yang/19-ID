...
proc beam_size_x_move { new_beam_size_x } {
	...
	set new_slit_2 [slit_2_calculate $new_beam_size_x]
...
proc beam_size_x_set { new_beam_size_x } {
	...
	# set three motors
	set slit_2 [slit_2_calculate $new_beam_size_x]
}
...
proc beam_size_x_update {} {
	...
	return [beam_size_x_calculate $slit_2]
}


proc beam_size_x_calculate { f } {
