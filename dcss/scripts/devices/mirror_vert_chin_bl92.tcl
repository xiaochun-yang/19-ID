...
proc mirror_vert_chin_initialize {} {
	...
	set_children mirror_vert mirror_slit_upper mirror_chin_gap
...
proc mirror_vert_chin_move { new_mirror_vert_chin } {
	...
	if { $new_mirror_vert > $mirror_vert } {
        assertMotorLimit mirror_chin_gap [mirror_chin_gap_calculate $new_mirror_vert $mirror_slit_upper]	
        ...
        assertMotorLimit mirror_chin_gap [mirror_chin_gap_calculate $mirror_vert $new_mirror_slit_upper]	
