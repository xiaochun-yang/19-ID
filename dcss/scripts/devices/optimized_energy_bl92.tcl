...
proc smartOptimize {} {
   ...
   puts $handle "[time_stamp] Attenuation after scan: $attenuation"
	...
	#This is to prevent the slits closing down by ~0.001 after each optimization. Will be obsolete when bug 344 is solved

#   while { $beam_size_y < $oldbeam_size_y} {
#		move beam_size_y to [expr $beam_size_y + 0.001]
#		wait_for_devices beam_size_y
#	}
#   while { $beam_size_x < $oldbeam_size_x} {
#		move beam_size_x to [expr $beam_size_x + 0.001]
