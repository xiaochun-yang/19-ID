...
proc slit_pos_y_move { new_slit_pos_y } {

	global gDevice
	variable beam_size_y
  
	# calculate new positions of the two motors
	set new_slit_0_upper [slit_0_upper_calculate_p $new_slit_pos_y $gDevice(beam_size_y,target)]
	set new_slit_0_lower [slit_0_lower_calculate_p $new_slit_pos_y $gDevice(beam_size_y,target)]
...
proc slit_pos_y_set { new_slit_pos_y } {
	...
	# set three motors
	set slit_0_upper [slit_0_upper_calculate_p $new_slit_pos_y $beam_size_y]
	set slit_0_lower [slit_0_lower_calculate_p $new_slit_pos_y $beam_size_y]
}


proc slit_pos_y_update {} {
	...
	return [slit_pos_y_calculate $slit_0_upper $slit_0_lower]
}


proc slit_pos_y_calculate { upper lower } {
