...
proc undltrCheckReady { waitForReady } {
    ...
    if {$gapStatus == 1} {
        if {$waitForReady} {
            log_error undulator_gap not ready, waiting it to become Stopped
            log_error undulator_gap not ready, waiting it to become Stopped
...
proc undltrUpdateConfig { } {
    ...
    setUpperLimitFromScaledValue undulator_gap $gapRequestDrvH
    setLowerLimitFromScaledValue undulator_gap $gapRequestDrvL
