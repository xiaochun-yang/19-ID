#ifndef GW_ASGalil_STRING_MOTOR_H
#define GW_ASGalil_STRING_MOTOR_H

#include "GwBaseMotor.h"

class GwASGalilMotor: public GwBaseMotor
{
public:
    GwASGalilMotor( const char DCSName[], const char localName[], bool real );
    virtual ~GwASGalilMotor( ) { disconnectAll( ); }
...
protected:
    ...
    //ASGalilMotor special
    void sendASGalilMoveCompleted( );
    void sendASGalilConfig( );
...
protected:
    ...
    enum MOTOR_CHID_INDEX
    {
        ...
        CHID_HIGH_LIMIT_STS = CHID_END_OF_MIN,
        CHID_LOW_LIMIT_STS,
        CHID_ERROR_STS,
        CHID_DRVH,
        CHID_DRVL,
