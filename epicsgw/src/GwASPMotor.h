#ifndef GW_ASP_STRING_MOTOR_H
#define GW_ASP_STRING_MOTOR_H

#include "GwBaseMotor.h"

class GwASPMotor: public GwBaseMotor
{
public:
    GwASPMotor( const char DCSName[], const char localName[], bool real );
    virtual ~GwASPMotor( ) { disconnectAll( ); }
