#ifndef __ImpWriteFiles_h__
#define __ImpWriteFiles_h__

/**
 * @file ImpWriteFiles.h
 * Header file for ImpWriteFiles class.
 */
...
class ImpWriteFiles : public ImpCommand
{
public:
     ...
     */
    ImpWriteFiles(HttpServer* s);

    ImpWriteFiles(const std::string& n, HttpServer* s);

    /**
     * @brief Destructor.
     */
    virtual ~ImpWriteFiles();
