...
source ../scripts/DhsProtocol.tcl
source ../scripts/PilatusControl.tcl
source ../scripts/FileMover.tcl
source ../scripts/ImpWriteFiles.tcl
source ../tests/TestFileMover.tcl

set di [DCS::DependencyInjector #auto ]
$di load ../config/pilatus.config

#$di createObjectByName testImpMoveFiles
$di createObjectByName testFileMover
