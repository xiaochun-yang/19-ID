...
proc printUsage {} {
	puts "-----------------------------------------------------------------------------"
	puts "Usage: run.tcl beamline detector "
	puts " "
   printAvailableConfigs
}
...
if { [catch {
   ...
   set beamline [lindex $argv 0]
	...
	puts "\033]2;dhs pilatusDhs for $beamline on $env(HOST)\07"
...
source DhsProtocol.tcl
source PilatusControl.tcl
source FileMover.tcl
source ImpWriteFiles.tcl
source Logger.tcl
