...
if { [catch {
   ...
   set beamline [lindex $argv 0]
	...
	puts "\033]2;temperature dhs for $beamline on $env(HOST)\07"
...
DCS::DhsProtocol dcss $serverName $serverPort -_reconnectTime 1000 -callback "handle_stoh_messages" -networkErrorCallback "handle_network_error" -hardwareName temperatureDhs 
